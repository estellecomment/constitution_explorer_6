...
Drupal.locale={pluralFormula:function($n){return Number(($n>1))},strings:{Upload:"Transfert de fichiers","An error occurred at ":"Une erreur s\'est produite à","jQuery UI Tabs: Mismatching fragment identifier.":"Onglets d\'interface jQuery : identifiant de fragment ne correspondant pas.","jQuery UI Tabs: Not enough arguments to add tab.":"Onglets d\'interface jQuery : pas assez d\'arguments pour ajouter l\'onglet.","Remove this item":"Supprimer cet élément"}};
