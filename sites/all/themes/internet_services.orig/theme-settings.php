 ...
 *   A form array.
 */
function internet_services_settings($saved_settings) {

  // Get the default values from the .info file.
  $defaults = zen_theme_get_default_settings('internet_services');
  ...
  $form['internet_services_example'] = array(
    '#type'          => 'checkbox',
    '#title'         => t('Use this sample setting'),
    '#default_value' => $settings['internet_services_example'],
