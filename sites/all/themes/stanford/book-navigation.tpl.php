...
<div id="book-navigation-<?php print $book_id; ?>" class="book-navigation"> <?php print $tree; ?>
  <?php if ($has_links): ?>
  <div class="page-links clear-block">
    <?php if ($prev_url) : ?>
    <div class="page-previous"><a href="<?php print $prev_url; ?>" title="<?php print t('Go to previous page'); ?>"><?php print t('‹ ') . $prev_title; ?></a></div>
    <?php endif; ?>
    <?php if ($parent_url) : ?>
    <div class="page-up"><a href="<?php print $parent_url; ?>" title="<?php print t('Go to parent page'); ?>"><?php print t('up'); ?></a></div>
    <?php endif; ?>
    <?php if ($next_url) : ?>
    <div class="page-next"><a href="<?php print $next_url; ?>" title="<?php print t('Go to next page'); ?>"><?php print $next_title . t(' ›'); ?></a></div>
    <?php endif; ?>
  </div>
  <?php endif; ?>
</div>
